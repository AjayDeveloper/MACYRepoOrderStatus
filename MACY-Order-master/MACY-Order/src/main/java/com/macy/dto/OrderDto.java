...
public class OrderDto {
	...
	public OrderDto() {}
	public OrderDto(int orderId, String messageName, String command, String itemName, String itemDescription, double itemLength,
	...
	public String toString() {
		return "OrderDto [messageName=" + messageName + ", command=" + command + ", itemName=" + itemName
